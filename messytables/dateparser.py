...
def create_date_formats(day_first=True):
    ...
    for separator in date_separators:
        for date_format, python_date_format in both_date_formats:
            all_date_formats.append((date_format.replace("/", separator), python_date_format.replace("/", separator)))
    ...
    for date_format, python_date_format in all_date_formats:
        ...
        for time_format, python_time_format in both_time_formats:
            all_formats[date_format + time_format] = python_date_format + python_time_format

            all_formats[date_format + "T" + time_format] = python_date_format + "T" + python_time_format
